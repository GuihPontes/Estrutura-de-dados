...
int inputProntuario()
{
    ...
    do
    {
        ...
        {
            cout << endl
                 << "Prontuario deve ser positivo" << endl
                 << endl;
        }
...
int inputProntuarioUnico(ListaFuncionario *lista)
{
    ...
    do
    {
        ...
        {
            cout << endl
                 << "Esse prontuario já foi utilizado, por favor digite outro" << endl
                 << endl;
        }
...
double inputSalario()
{
    ...
    do
    {
        ...
        {
            cout << endl
                 << "Salario deve ser positivo" << endl
                 << endl;
        }
...
ListaFuncionario *incluirFuncionario(ListaFuncionario *lista)
{
    ...
    novoFuncionario.prontuario = inputProntuarioUnico(lista);
    novoFuncionario.nome = inputNome();
    novoFuncionario.salario = inputSalario();

    return insert(lista, novoFuncionario);
}
...
void pesquisarFuncionario(ListaFuncionario *lista)
{
    ...
    {
        cout << endl
             << "Não há funcionario com o prontuario " << prontuario << endl
             << endl;
        return;
    }
...
int main(int argc, char **argv)
{
    ...
    while (opcao != 0)
    {
        ...
        default:
            cout << endl
                 << "Opção invalida - por favor selecione um valor de 0 até 4" << endl
                 << endl;
            break;
        }
